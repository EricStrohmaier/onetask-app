      ...
      {view === 'check-email' ? (
        ...
        >
            ...
            <div className='text-md my-2 relative bottom-10 bg-gray-200 rounded-3xl p-3 flex flex-col items-center text-left'>
                ...
                <p className='my-2 mx-2'>Login with the   {" "}<span onClick={handleDemoSignIn} className='font-semibold cursor-pointer bg-gray-500 text-white p-1 px-3 rounded-2xl uppercase'>demo account</span></p>
